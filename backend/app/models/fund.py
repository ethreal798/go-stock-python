...
class FundExchangeNavHistory(GormBaseModel):
    """场内 ETF 净值历史；LOF 仍按开放式基金口径处理。"""

    __tablename__ = "fund_exchange_nav_history"
    __table_args__ = (UniqueConstraint("fund_id", "data_date", name="uq_fund_exchange_nav_history_fund_date"),)
